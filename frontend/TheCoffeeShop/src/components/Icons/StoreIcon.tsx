      ...
      <Svg
        ...
        <G id='SVGRepo_iconCarrier'>
          ...
          <Path
            ...
            d='M47.421,242.412c19.211,0,34.786-15.574,34.786-34.786H12.636 C12.636,226.838,28.209,242.412,47.421,242.412L47.421,242.412z'
          />
          <Path
            // @ts-ignore
            style={{
            ...
            d='M116.993,242.412c19.211,0,34.786-15.574,34.786-34.786H82.207 C82.207,226.838,97.78,242.412,116.993,242.412L116.993,242.412z'
          />
          <Path
            // @ts-ignore
            style={{
            ...
            d='M186.564,242.412c19.211,0,34.786-15.574,34.786-34.786h-69.571 C151.778,226.838,167.351,242.412,186.564,242.412L186.564,242.412z'
          />
          <Path
            // @ts-ignore
            style={{
            ...
            d='M256.135,242.412c19.211,0,34.786-15.574,34.786-34.786h-69.571 C221.349,226.838,236.922,242.412,256.135,242.412L256.135,242.412z'
          />
          <Path
            // @ts-ignore
            style={{
            ...
            d='M325.706,242.412c19.211,0,34.786-15.574,34.786-34.786H290.92 C290.92,226.838,306.493,242.412,325.706,242.412L325.706,242.412z'
          />
          <Path
            // @ts-ignore
            style={{
            ...
            d='M395.277,242.412L395.277,242.412c19.211,0,34.786-15.574,34.786-34.786h-69.571 C360.491,226.838,376.065,242.412,395.277,242.412z'
          />
          <Path
            // @ts-ignore
            style={{
            ...
            d='M464.848,242.412c19.211,0,34.786-15.574,34.786-34.786h-69.571 C430.063,226.838,445.636,242.412,464.848,242.412L464.848,242.412z'
          />
          <Polygon
            // @ts-ignore
            style={{
            ...
            points='56.118,7.609 108.296,7.609 82.207,207.626 12.636,207.626 '
          />
          <Polygon
            // @ts-ignore
            style={{
            ...
            points='108.296,7.609 169.171,7.609 151.778,207.626 82.207,207.626 '
          />
          <Polygon
            // @ts-ignore
            style={{
            ...
            points='169.171,7.609 221.349,7.609 221.349,207.626 151.778,207.626 '
          />
          <Rect
            x={221.345}
            y={7.609}
          ...
          <Polygon
            ...
            points='290.92,7.609 343.099,7.609 360.491,207.626 290.92,207.626 '
          />
          <Polygon
            // @ts-ignore
            style={{
            ...
            points='343.099,7.609 403.973,7.609 430.063,207.626 360.491,207.626 '
          />
          <Polygon
            // @ts-ignore
            style={{
            ...
            points='403.973,7.609 456.152,7.609 499.634,207.626 430.063,207.626 '
          />
          <Rect
            x={82.203}
            y={268.501}
          ...
          <G>
            <Polygon
              ...
              points='387.668,268.501 283.311,372.858 355.056,372.858 412.67,315.244 412.67,268.501 '
            />
            <Polygon
              // @ts-ignore
              style={{
              ...
              points='273.528,268.501 273.528,334.811 339.838,268.501 '
            />
            <Polygon
              // @ts-ignore
              style={{
              ...
              points='380.602,372.858 412.67,372.858 412.67,340.79 '
            />
          </G>
          <Circle
            // @ts-ignore
