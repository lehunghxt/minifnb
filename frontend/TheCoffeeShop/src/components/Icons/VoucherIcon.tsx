...
const VoucherIcon = (props: IconProps) => {
      ...
      <G id='SVGRepo_iconCarrier'>
        ...
        <G>
          ...
          <Path
            ...
            d='M402.206,188.873c1.922-1.93,3.125-4.594,3.125-7.539c0-5.891-4.781-10.671-10.672-10.671 c-2.953,0-5.609,1.195-7.546,3.125L237.789,323.119c-1.929,1.938-3.124,4.594-3.124,7.531c0,5.906,4.772,10.687,10.663,10.687 c2.945,0,5.617-1.203,7.547-3.14L402.206,188.873z'
          />
        </G>
        <Path
          // @ts-ignore
          ...
          d='M10.671,117.336C4.78,117.336,0,122.109,0,128v255.992c0,5.891,4.78,10.656,10.671,10.656h95.997 l21.328-21.312l0,0V330.65c-5.891,0-10.664-4.766-10.664-10.656s4.773-10.656,10.664-10.656v-21.343 c-5.891,0-10.664-4.781-10.664-10.656c0-5.897,4.773-10.679,10.664-10.679v-21.328c-5.891,0-10.664-4.781-10.664-10.671 s4.773-10.664,10.664-10.664v-21.335c-5.891,0-10.664-4.773-10.664-10.664s4.773-10.664,10.664-10.664v-42.671l-21.328-21.327 L10.671,117.336L10.671,117.336z'
        />
      </G>
    </Svg>
  );
